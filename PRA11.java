...
public class PRA11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Dhruv Vekariya", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Aadarsh Tank", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Jay Thanki", 89, 'M');
